...
const Register = React.memo(({registredThunk, registerStatus, startLoader}) => {
    ...
    return (
        <div className={s.register}>
            ...
            <RegisterForm startLoader={startLoader} registerStatus={registerStatus} registredThunk={registredThunk}/>
        </div>
    )
})
